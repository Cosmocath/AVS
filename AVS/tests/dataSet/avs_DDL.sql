...
ALTER TABLE `avs`.`Profil` AUTO_INCREMENT = 100;
ALTER TABLE `avs`.`Droit` AUTO_INCREMENT = 100;
ALTER TABLE `avs`.`Utilisateur` AUTO_INCREMENT = 100;
ALTER TABLE `avs`.`Commande` AUTO_INCREMENT = 100;
ALTER TABLE `avs`.`ProduitVendu` AUTO_INCREMENT = 100;
ALTER TABLE `avs`.`Produit` AUTO_INCREMENT = 100;
ALTER TABLE `avs`.`CommandeProduit` AUTO_INCREMENT = 100;
ALTER TABLE `avs`.`ProfilDroit` AUTO_INCREMENT = 100;
