...
class FormatUtilTest {
    ...
    /**
     * le mois dans le calendar est compté à partir de zero c'est-à-dire que le mois de janvier est le mois 0 et le mois de décembre est le mois 11. Important pour la saisie du test. Test method for
